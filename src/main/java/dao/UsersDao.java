...
public class UsersDao extends Dao implements UsersDaoInterface {
    ...
    public Users findUserByUserID(int user_id) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Exception occurred in the finally section of the findUserByUserID() method: " + e.getMessage());
            }
        }
        return u;
    }
    ...
    public int deleteUser(int user_id) {
        ...
        if (rows == 0) {
            System.err.println("No user with the user_id:  " + user_id + " for deletion");
        }
